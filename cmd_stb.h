...
CMD_REG(smodon,  "", "Switch CB and all modules on")
CMD_REG(smodoff, "", "Switch CB and all modules off")
CMD_REG(shv, "", "HV test (switches CB and all modules on)")
CMD_REG(srda, "[<sel> [<hub>]]", "RDA read back signal test D1=trg, A1=SDA, A2=RDA")
